...
export default function ChatInterface({ formData }: { formData: any }) {
      ...
      setMessages([
        {
          ...
          citations: [
            { source: "The Patents Act, 1970", section: "Section 3(p) - What are not inventions", url: "#" },
            { source: "Biological Diversity Act, 2002", section: "Section 3(2) - Prior approval for certain persons", url: "#" }
          ]
        }
      ]);
      setIsTyping(false);
  ...
  const handleSend = async () => {
    ...
    const newAssistantMsg: Message = {
      ...
      role: "assistant",
      content: "This is a placeholder response. In the actual integration, LAURA will utilize the vector database and LLM to provide a highly accurate, cited response based specifically on the context of your question.",
    };
