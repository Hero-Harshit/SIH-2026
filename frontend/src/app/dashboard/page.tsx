      ...
      <div className="flex flex-1 w-full max-w-[1600px] mx-auto relative">
        ...
        <aside className="hidden lg:flex w-16 hover:w-64 fixed left-0 top-[73px] h-[calc(100vh-73px)] border-r border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl z-20 flex-col py-6 gap-4 group transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          <div className="px-3 w-full flex flex-col gap-3">
            <Link href="/" className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 dark:text-muted-foreground hover:text-brand-600 hover:bg-brand-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="Home">
            ...
            <div className="w-full flex items-center gap-4 p-3 rounded-xl text-brand-600 bg-brand-50/80 shadow-sm transition-all relative overflow-hidden group/btn" title="Assessment">
            ...
            <Link href="/corpus" className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 dark:text-muted-foreground hover:text-brand-600 hover:bg-brand-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="Legal Corpus">
          ...
          <div className="mt-auto px-3 w-full">
            <Link href="/settings" className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 dark:text-muted-foreground hover:text-brand-600 hover:bg-brand-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="Settings">
