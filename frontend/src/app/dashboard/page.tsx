      ...
      <div className="flex flex-1 w-full max-w-[1600px] mx-auto relative">
        ...
        <aside className="hidden lg:flex w-16 hover:w-64 fixed left-0 top-[73px] h-[calc(100vh-73px)] border-r border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl z-20 flex-col py-6 gap-4 group transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          <div className="px-3 w-full flex flex-col gap-3">
            ...
            <div className="w-full flex items-center gap-4 p-3 rounded-xl text-brand-600 bg-brand-50/80 shadow-sm transition-all relative overflow-hidden group/btn" title="Dashboard">
          ...
          <div className="w-full max-w-4xl">
            {!formData ? (
              ...
              <div className="flex flex-col items-center justify-center h-[50vh] text-center formal-panel rounded-2xl p-10 animate-in fade-in zoom-in duration-500">
                ...
                <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-2">Assessment Submitted</h2>
                ...
                <button 
                  ...
                  className="mt-8 px-6 py-2.5 rounded-xl text-sm font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 hover:border-brand-400 hover:text-brand-700 shadow-sm transition-all"
                >
                  Restart Assessment
                </button>
              </div>
