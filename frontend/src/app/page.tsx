      ...
      <div className="flex flex-1 w-full max-w-[1600px] mx-auto relative">
        ...
        <aside className="hidden lg:flex w-16 hover:w-64 fixed left-0 top-[73px] h-[calc(100vh-73px)] border-r border-slate-200 bg-white/80 backdrop-blur-xl z-20 flex-col py-6 gap-4 group transition-all duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] overflow-hidden shadow-[1px_0_10px_rgba(0,0,0,0.02)]">
          <div className="px-3 w-full flex flex-col gap-3">
            <button className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 hover:text-gold-600 hover:bg-gold-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="Dashboard">
            ...
            <button className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 hover:text-gold-600 hover:bg-gold-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="History">
              <svg className="shrink-0" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/></svg>
              <span className="font-semibold text-sm tracking-wide whitespace-nowrap opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">Assessment History</span>
            </button>
          </div>
          
          <div className="mt-auto px-3 w-full">
            <button className="w-full flex items-center gap-4 p-3 rounded-xl text-slate-400 hover:text-gold-600 hover:bg-gold-50/80 hover:shadow-sm transition-all relative overflow-hidden group/btn" title="Settings">
